...
function UpdateCase(props) {
    ...
    useEffect(() => {
        ...
        axios.get('http://locahost:3004/cases/' + id)
            .then(res => {
                const data = res.data;
                setCase({
                    defendantName: data.defendantName,
                    defendantAddr: data.defendantAddr,
                    crimeType: data.crimeType,
                    crimeDate: data.crimeDate,
                    crimeLoc: data.crimeLoc,
    ...
    const onSubmit = (e) => {
        ...
        axios.post('http://localhost/cases/update'+updatedCase._id, updatedCase)
